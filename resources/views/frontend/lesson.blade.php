                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                ...
                                <button @class([  
                                    ...
                                    <p class="mb-0 flex-grow-1">{{ __($topic->title) }}</p><span class="me-3">{{ $topic->complete_lessons_count }}/{{ $topic->lessons_count }}</span>
                                </button>
            ...
            <div class="col-lg-8 lesson-pane">
                ...
                <div class="header d-flex">
                    <div class="d-flex align-items-center flex-grow-1">
                        ...
                        <p class="mb-0">{{ __($course_title) }}</p>
                    </div>
                                ...
                                @foreach($active_lesson->exercise_files as $exercise_file)
                                    ...
                                    <a href="{{ $exercise_file->file_url }}">
                                        <div class="d-flex p-3">
                                            <div>
                                                <p class="mb-0">{{ $exercise_file->title }}</p>
                                            </div>
