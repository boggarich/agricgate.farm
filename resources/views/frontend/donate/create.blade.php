        ...
        <div id="payment" class="animated fadeIn mt-5">
            ...
            <div class="payment-wrapper">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="mobile-money" role="tabpanel" aria-labelledby="mobile-money-tab" tabindex="0">
                        <div class="payment-form-wrapper" id="paymentForm">

                            <p>Enter your mobile money number and provider to start the payment</p>

                            <form action="{{ route('donate.charge', [ 'channel' => 'mobile_money' ] ) }}" method="POST">

                                @csrf

                                <div class="form-group mb-3">
                                    <select class="form-control" id="networkProvider" name="provider">
                                ...
                                <div class="form-group mb-3">
                                    <input type="text" name="phone" class="form-control" placeholder="050 000 0000" value="" required>
                                </div>
                                ...
                                <button type="submit" class="btn btn-success d-table mx-auto w-100">Confirm</button>
                    ...
                    <div class="tab-pane" id="card" role="tabpanel" aria-labelledby="card-tab" tabindex="0">
                        ...
                        <div class="row mb-2">
                            <div class="col">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" class="form-control" placeholder="07/23" value="">
                                </div>
                            </div>
                            <div class="col">
